...
kubectl patch deployments.apps -n openfunction openfunction-controller-manager -p "{\"spec\":{\"template\":{\"spec\":{\"containers\":[{\"name\":\"openfunction\",\"image\":\"$1\",\"imagePullPolicy\":\"IfNotPresent\",\"resources\":null}]}}}}"
