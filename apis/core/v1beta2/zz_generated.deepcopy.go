...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KnativeScaleOptions) DeepCopyInto(out *KnativeScaleOptions) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KnativeScaleOptions.
func (in *KnativeScaleOptions) DeepCopy() *KnativeScaleOptions {
	if in == nil {
		return nil
	}
	out := new(KnativeScaleOptions)
	in.DeepCopyInto(out)
	return out
}
